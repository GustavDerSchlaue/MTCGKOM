...
echo kienboec
echo curl -X GET http://localhost:10001/deck?format=plain --header "Authorization: Basic kienboec-mtcgToken"
echo.
echo.
echo altenhof
echo curl -X GET http://localhost:10001/deck?format=plain --header "Authorization: Basic altenhof-mtcgToken"
echo.
echo.
...
REM --------------------------------------------------
echo unique feature) Reset kienboc
curl -X DELETE http://localhost:10001/reset --header "Authorization: Basic kienboec-mtcgToken"
echo.
echo.
